...
const Drawer: FC<DrawerProps> = ({ open, closeDrawer }) => {
	return (
		<div
			className={clsx(
				'bg-white border border-gray-500/20 rounded absolute h-2/3 right-0 z-50 w-[400px] shadow-lg transform-transition duration-300 flex flex-col justify-between p-4',
